...
async _onCapability( capabilityValues, capabilityOptions){
  ...
  if( capabilityValues["media_data_refresh"] != undefined){
...
//      this.log('Batterie Heizung:',vehicle_battery_heater)
      ...
      if (typeof formattedSyncDate !== 'undefined') {
        this.setCapabilityValue('media_last_update', formattedSyncDate);
      } else {
        this.log('Fehler --> last_sync ist nicht definiert');
        this.setCapabilityValue('media_last_update', 'n/a');
      }
